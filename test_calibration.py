...
ret_stereo, mtx_l, dist_l, mtx_r, dist_r, mtx_R, mtx_T, mtx_E, mtx_F = cv2.stereoCalibrate(objpoints, imgpoints_l,
                                                                                           imgpoints_r, None, None,
                                                                                           None, None, (w, h),
                                                                                           flags=flags_sc,
                                                                                           criteria=term_crit_sc)
...
mtx_R_l, mtx_R_r, mtx_P_l, mtx_P_r, mtx_Q, roi_rec_l, roi_rec_r = cv2.stereoRectify(mtx_l, dist_l, mtx_r, dist_r,
                                                                                    (w, h), mtx_R, mtx_T, alpha=0)
