...
# %% LOAD IMAGES
dir_dataset = 'Stereo_conveyor_without_occlusions'
...
for i in range(n_images):
    ...
    cv2.putText(frame_rgb_curr_undist_rect, "Undistorted rectified (Left)", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1,
                (0, 0, 255), 2)
    cv2.putText(frame_rgb_curr_undist_rect_right, "Undistorted rectified (Right)", (50, 50), cv2.FONT_HERSHEY_SIMPLEX,
                1, (0, 0, 255), 2)
